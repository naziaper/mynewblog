				...
				<article <?php post_class( $classes ); ?> id="post-<?php the_ID(); ?>" >
					...
					<header class="post-header">
						<?php if (etheme_get_option('blog_featured_image') && !etheme_get_custom_field('post_featured')): ?>
							...
							<?php if( etheme_get_option( 'single_post_title' ) && ($post_format == 'audio' || $post_format == 'video') && $post_template == 'large' && $post_template == 'large2' ): ?>
						...
						<?php if( etheme_get_option( 'single_post_title' ) && $post_format != 'quote' && $post_template != 'large' && $post_template != 'large2'): ?>
							<div class="post-heading">
