...
class ETheme_Version_Check {
    ...
    public function major_update( $type = 'msg' ) {
        ...
        $versions = array( '4.0', '5.0', '6.0', '7.0' );
        ...
        $message = esc_html__( 'This is major theme update! Please, do the backup of your files and database before proceed to update', 'xstore' );
