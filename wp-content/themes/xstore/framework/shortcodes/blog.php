...
class ETheme_Blog_Shortcodes {
	...
	public function get_params( $args = array() ) {
		...
		$params_array = array(
			...
			array(
				'type' => 'textfield',
				'heading' => isset( $args['items_per_page']['heading'] ) ? $args['items_per_page']['heading'] : esc_html__( 'Items per page', 'xstore' ),
				'param_name' => 'items_per_page',
				'description' => isset( $args['items_per_page']['description'] ) ? $args['items_per_page']['description'] : esc_html__( 'Number of items to show per page.', 'xstore' ),
				'value' => '10',
				/*'dependency' => array(
                    'element' => 'style',
	...
	public function get_carousel_params() {
		...
		$args = array(
			'items_per_page' => array(
				...
				'description' => esc_html__( 'Use "-1" to show all posts.', 'xstore' ),
			), 
		);
		return array_merge( $this->get_params( $args ), array(
			array(
				'type' => 'dropdown',
