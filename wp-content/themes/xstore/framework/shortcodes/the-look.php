...
function etheme_the_look_shortcode($atts, $content) {
    ...
    if ( $products->have_posts() ) : ?>
      <div id="et-look-<?php echo $id; ?>" class="et-look" data-class="<?php echo esc_attr($images_class); ?>">
            ...
            <?php $i=0; while ( $products->have_posts() ) : $products->the_post(); ?>
                <?php 
                    ...
                    if( $banner_pos == $i ) {
                      ...
                      echo '<div class="' . $class . ' et-isotope-item et_banner-section" data-position="' . $banner_pos . '"><div class="content-product">';
            ...
            <script>
              jQuery(document).ready(function($){
                ...
                function banner_position() {
                  var length = $( '#et-look-<?php echo $id; ?> .et-isotope-item' ).length;
                  var position = $( '#et-look-<?php echo $id; ?> .et-isotope-item.et_banner-section' ).data( 'position' );
                  ...
                  $.each( $( '#et-look-<?php echo $id; ?> .et-isotope-item') , function( e, t ) {
