...
Go to Dashboard > Updates to update theme.</p>
...
Once imported, this content can be managed from the WordPress dashboard.  </p>
		...
		public function envato_setup_updates() {
			...
			<?php else: ?>
				...
				<p><?php esc_html_e('A purchase code (license) is only valid for One Project. Do you want to use this theme for a one more project? Purchase a ', 'xstore'); ?> <a href="https://themeforest.net/item/xstore-responsive-woocommerce-theme/15780546?license=regular&open_purchase_for_item_id=8611976&purchasable=source&ref=8theme"><?php esc_html_e('new license here', 'xstore'); ?></a><?php esc_html_e(' to get a new purchase code.', 'xstore'); ?></p>
		...
		?>
			...
			<?php
				...
				if(isset($_REQUEST['theme_name']) && isset($_REQUEST['theme_template']) && current_user_can('manage_options')){
					echo $this->_make_child_theme(esc_html($_REQUEST['theme_name']), esc_html($_REQUEST['theme_template'])); 
				}
			...
			<form action="<?php $_PHP_SELF ?>" method="POST">
			 <div class="child-theme-input" style="margin-bottom: 20px;">
		 	 ...
		 	 <div class="child-theme-input" style="margin-bottom: 20px;">
				  ...
				  <input type="text" name="theme_template" value="<?php echo $template; ?>" />
			 </div>
			<p class="envato-setup-actions step">
