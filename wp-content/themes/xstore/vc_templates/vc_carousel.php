...
?>
	...
	<div class="swiper-container posts-carousel items-carousel carousel-design-<?php echo $design; ?> slider-<?php echo $box_id; ?>" data-breakpoints="1" data-xs-slides="3" data-sm-slides="3" data-md-slides="3" data-lt-slides="3" data-slides-per-view="3" data-autoplay="<?php echo ($autoplay == 'yes') ? $speed : 'false'; ?>">
		...
		<?php foreach ( $posts as $post ): ?>
			...
			?>
                <div class="swiper-slide carousel-item"<?php echo $block_style ?>>
